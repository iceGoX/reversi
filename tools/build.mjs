...
const files=['assets/icons/favicon-32-v1.png','assets/icons/apple-touch-icon-v1.png','assets/icons/favicon-v1.svg','index.html','style.css','game.js','engine.js','package.json','server/app.js','assets/guava-v2.jpg','assets/grape.jpg'];
